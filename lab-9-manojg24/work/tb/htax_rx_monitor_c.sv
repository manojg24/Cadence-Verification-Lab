...
class htax_rx_monitor_c extends uvm_monitor;
	...
	// Coverpoint for rx_vc_gnt: All the virtual channels are granted atleast once.
		c1: coverpoint htax_rx_intf.rx_vc_gnt {bins b1 = {1,2,3}; illegal_bins b2 = {0};}
	

	// Coverpoint for rx_vc_req: All the VCs are requested atleast once. Ignore what is not allowed, or put it as illegal
